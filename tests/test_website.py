...
class CheckSiteAvailability(unittest.TestCase):
    ...
    """
    def setup(self):
        driver_path = ChromeDriverManager(chrome_type=ChromeType.CHROMIUM).install() # installing the driver to memorypython3 -m http.server
        ...
        self.website_url = "os.chdir(../src/index.html)" 
